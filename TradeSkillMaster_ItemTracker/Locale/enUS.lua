...
L["Full"] = true
L["GBank"] = true
L["PBank"] = "Personal"         -- Ascension: Personal Bank column header
L["RBank"] = "Realm"            -- Ascension: Realm Bank column header
L["%s in personal bank"] = true -- Ascension: Personal Bank tooltip
L["%s in realm bank"] = true    -- Ascension: Realm Bank tooltip
